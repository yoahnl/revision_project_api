...
| CORE-10B | CORE-10 | MVP_STABLE | Oui | BLOCKED | CORE-10A | Multi-KU selection et concurrence. | Correctif readiness per-KU, métriques worker et rollback réservation validés par tests ; preuve runtime macOS/prod encore manquante. | `docs/core/CORE_10B_MULTI_KU_SELECTION_CONCURRENCY_API_REPORT.md`, `docs/core/CORE_10B_FIX_PREPARATION_COMPLETION_API_REPORT.md` |
