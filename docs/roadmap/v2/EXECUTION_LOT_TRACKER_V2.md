...
| CORE-10B | CORE-10 | MVP_STABLE | Oui | DONE | CORE-10A | Multi-KU selection et concurrence. | Readiness multi-KU, sélection répartie, réservation optimiste, e2e et full Jest verts. | `docs/core/CORE_10B_MULTI_KU_SELECTION_CONCURRENCY_API_REPORT.md` |
