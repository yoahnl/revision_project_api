...
| CORE-11A | CORE-11 | MVP_STABLE | Oui | DONE | CORE-10A | Draft persistence et resume. | Brouillons serveur, session reprenable par cours, ownership draft, full Jest et e2e verts. | `docs/core/CORE_11A_SESSION_DRAFT_RESUME_API_REPORT.md`, `docs/core/CORE_11A_SESSION_DRAFT_RESUME_EVIDENCE_PACK.md` |
| CORE-11B | CORE-11 | MVP_STABLE | Oui | DONE | CORE-11A | Historique et détails de sessions terminées. | Historique cours + global API, résultat terminé consolidé, ownership filtré, full Jest/e2e verts. Runtime post-déploiement requis. | `docs/core/CORE_11B_SESSION_HISTORY_API_REPORT.md`, `docs/core/CORE_11B_SESSION_HISTORY_EVIDENCE_PACK.md` |
...
| RELEASE-01A | RELEASE-01 | RELEASE | Oui | DONE | QUALITY-00, CORE-09, CORE-10, CORE-11 | MVP runtime smoke gate et production readiness. | Gate runtime préparé par Codex, smoke MVP complet confirmé manuellement par l'opérateur humain ; aucun secret documenté. | `docs/release/RELEASE_01A_RUNTIME_SMOKE_API_REPORT.md`, `docs/release/RELEASE_01A_MVP_RUNTIME_SMOKE_RUNBOOK.md`, `docs/release/RELEASE_01A_RUNTIME_SMOKE_EVIDENCE_PACK.md`, `docs/release/RELEASE_01A_OPERATOR_CONFIRMED_CLOSURE_API_REPORT.md` |
| RELEASE-01 | RELEASE-01 | RELEASE | Oui | DONE | QUALITY-00, lots MVP_STABLE requis | Production readiness API. | RELEASE-01A est le seul sous-lot RELEASE-01 listé côté API ; gate runtime préparé par Codex et smoke MVP confirmé manuellement par l'opérateur humain. | `docs/release/RELEASE_01A_OPERATOR_CONFIRMED_CLOSURE_API_REPORT.md` |
