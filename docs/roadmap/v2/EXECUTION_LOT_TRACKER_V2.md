...
| RELEASE-01A | RELEASE-01 | RELEASE | Oui | IN_PROGRESS | QUALITY-00, CORE-09, CORE-10, CORE-11 | MVP runtime smoke gate et production readiness. | API/App CORE-11B déployées, migrations appliquées, `/health/readiness` ajouté, Redis/worker observés ; smoke MVP complet encore à exécuter. | `docs/release/RELEASE_01A_RUNTIME_SMOKE_API_REPORT.md`, `docs/release/RELEASE_01A_MVP_RUNTIME_SMOKE_RUNBOOK.md`, `docs/release/RELEASE_01A_RUNTIME_SMOKE_EVIDENCE_PACK.md` |
| RELEASE-01 | RELEASE-01 | RELEASE | Oui | IN_PROGRESS | QUALITY-00, lots MVP_STABLE requis | Production readiness API. | RELEASE-01A prépare le gate runtime ; passage DONE interdit tant que le smoke MVP complet n'est pas prouvé. | `docs/release/RELEASE_01A_RUNTIME_SMOKE_API_REPORT.md` |
