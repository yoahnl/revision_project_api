...
| CORE-10B | CORE-10 | MVP_STABLE | Oui | BLOCKED | CORE-10A | Multi-KU selection et concurrence. | Fix-2 valide localement readiness stale, logs worker/runtime et métriques IA ; preuve runtime Dokploy + Marionette encore manquante. | `docs/core/CORE_10B_MULTI_KU_SELECTION_CONCURRENCY_API_REPORT.md`, `docs/core/CORE_10B_FIX_PREPARATION_COMPLETION_API_REPORT.md`, `docs/core/CORE_10B_FIX_2_WORKER_PARTIAL_READINESS_API_REPORT.md` |
