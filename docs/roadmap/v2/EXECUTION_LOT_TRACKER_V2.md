...
| CORE-09C | CORE-09 | MVP_STABLE | Oui | DONE | CORE-09A | Lifecycle subject/course : rename/edit/archive si validé. | Routes lifecycle/PATCH/archive/delete, tests ciblés, e2e et intégration app. | `docs/core/CORE_09C_SUBJECT_COURSE_LIFECYCLE_API_REPORT.md` |
