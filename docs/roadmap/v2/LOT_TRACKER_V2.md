...
| CORE-09 | Source lifecycle & storage policy | MVP_STABLE | Oui | IN_PROGRESS | STAB-01A | CORE-09A, CORE-09B, CORE-09C | Sécuriser archive/suppression, stockage et lifecycle sujet/cours. | Tests Prisma/API. | `docs/core/CORE_09A_SOURCE_LIFECYCLE_API_REPORT.md`, `docs/core/CORE_09B_STORAGE_CLEANUP_API_REPORT.md` |
