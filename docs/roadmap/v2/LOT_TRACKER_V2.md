...
| CORE-11 | Session resume & history | MVP_STABLE | Oui | IN_PROGRESS | CORE-10A | CORE-11A, CORE-11B | Reprise et historique de sessions. | CORE-11A terminé : drafts serveur et reprise quick. CORE-11B historique terminé reste à faire. | `docs/core/CORE_11A_SESSION_DRAFT_RESUME_API_REPORT.md`, `docs/core/CORE_11A_SESSION_DRAFT_RESUME_EVIDENCE_PACK.md` |
