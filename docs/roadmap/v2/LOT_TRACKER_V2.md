...
| QUALITY-00 | CI baseline | FOUNDATION | Oui | TODO | STAB-00B | QUALITY-00 | Baseline CI API : Prisma, build, lint, tests et e2e critiques. | Pipeline reproductible. | À créer |
