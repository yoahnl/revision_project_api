...
| RELEASE-01 | Production readiness | RELEASE | Oui | DONE | QUALITY-00, lots MVP_STABLE requis | RELEASE-01A | CI complète, stockage, monitoring, quotas, secrets. | RELEASE-01A est le seul sous-lot RELEASE-01 listé côté API ; gate runtime préparé par Codex et smoke MVP confirmé manuellement par l'opérateur humain, sans secret documenté. | `docs/release/RELEASE_01A_RUNTIME_SMOKE_API_REPORT.md`, `docs/release/RELEASE_01A_MVP_RUNTIME_SMOKE_RUNBOOK.md`, `docs/release/RELEASE_01A_OPERATOR_CONFIRMED_CLOSURE_API_REPORT.md` |
