...
Version commune API/App. Miroir attendu côté App : `revision_project_app/docs/roadmap/v3/LOT_TRACKER_V3.md`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| PLUS-02 | QCM complet / rich questions recovery | H1 | API + App | TODO | MVP core fermé, CORE-10, CORE-11 | PLUS-02A, PLUS-02B | Restaurer un QCM riche, sourcé, corrigé et historisé. | QCM single/multiple, sources, visuels, correction, résultat et historique validés. | Rapports `PLUS_02A`, `PLUS_02B` |
